# TASK-0706 — Acknowledge-before-commit receiver
...
Implement one isolated flawed receiver whose primary intentional defect is: Return success before durable business state commits.
...
- reference_receivers/flawed/acknowledge-before-commit-receiver/**

**Allowed files**

- reference_receivers/flawed/acknowledge-before-commit-receiver/**
- tests/e2e/test_acknowledge_before_commit_receiver.py
...
```bash
uv run pytest -q tests/e2e/test_acknowledge_before_commit_receiver.py
