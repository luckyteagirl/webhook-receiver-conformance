# TASK-0707 — Side-effect-before-deduplication receiver
...
Implement one isolated flawed receiver whose primary intentional defect is: Commit a side effect before recording the logical event identity.
...
- reference_receivers/flawed/side-effect-before-deduplication-receiver/**

**Allowed files**

- reference_receivers/flawed/side-effect-before-deduplication-receiver/**
- tests/e2e/test_side_effect_before_deduplication_receiver.py
...
```bash
uv run pytest -q tests/e2e/test_side_effect_before_deduplication_receiver.py
