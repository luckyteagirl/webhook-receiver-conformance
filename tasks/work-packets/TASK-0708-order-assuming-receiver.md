# TASK-0708 — Order-assuming receiver
...
Implement one isolated flawed receiver whose primary intentional defect is: Reject or corrupt state when a dependent event arrives before its prerequisite.
...
- reference_receivers/flawed/order-assuming-receiver/**

**Allowed files**

- reference_receivers/flawed/order-assuming-receiver/**
- tests/e2e/test_order_assuming_receiver.py
...
```bash
uv run pytest -q tests/e2e/test_order_assuming_receiver.py
