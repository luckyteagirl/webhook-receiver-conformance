# TASK-0709 — Sensitive-logging receiver
...
Implement one isolated flawed receiver whose primary intentional defect is: Write secrets and sensitive fixture fields to ordinary logs.
...
- reference_receivers/flawed/sensitive-logging-receiver/**

**Allowed files**

- reference_receivers/flawed/sensitive-logging-receiver/**
- tests/e2e/test_sensitive_logging_receiver.py
...
```bash
uv run pytest -q tests/e2e/test_sensitive_logging_receiver.py
