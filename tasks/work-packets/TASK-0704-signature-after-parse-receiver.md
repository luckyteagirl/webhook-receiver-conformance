# TASK-0704 — Signature-after-parse receiver
...
Implement one isolated flawed receiver whose primary intentional defect is: Parse and reserialize JSON before signature verification.
...
- reference_receivers/flawed/signature-after-parse-receiver/**

**Allowed files**

- reference_receivers/flawed/signature-after-parse-receiver/**
- tests/e2e/test_signature_after_parse_receiver.py
...
```bash
uv run pytest -q tests/e2e/test_signature_after_parse_receiver.py
