...
| TASK-0501 | phase-05-observers-and-assertions | Implement observer protocol models and capability negotiation | TASK-0102, TASK-0003 | PG-05A | src/webhook_receiver_conformance/observers/protocol.py | medium |
